...
from .views.officer.issue import FarmerIssueResolveView, OfficerFarmerIssueListView
...
urlpatterns = [
    ...
    path("officer/issues/", OfficerFarmerIssueListView.as_view(), name="officer-issue-list"),
    path("officer/issues/<int:pk>/resolve/", FarmerIssueResolveView.as_view(), name="issue-resolve"),
]
