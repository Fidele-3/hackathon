...
class Message(models.Model):
    SOURCE_APP = "app"
    SOURCE_USSD = "ussd"
    SOURCE_CHOICES = [(SOURCE_APP, "App"), (SOURCE_USSD, "USSD")]
    ...
    # A USSD-originated report has no smartphone/photo capability -- worth
    # knowing when an officer decides how to follow up.
